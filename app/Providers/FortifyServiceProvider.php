...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    private function configureViews(): void
    {
        ...
        /**
         * Registration is invitation-only: this is an internal system, so the
         * form is never shown to someone who did not arrive from an invitation
         * email. CreateNewUser enforces the same rule on the POST, which is the
        ...
        Fortify::registerView(function (Request $request) {
            ...
            if ($invitation === null) {
                return redirect()->route('login')->withErrors([
                    'email' => __('Registration is by invitation only. Ask an administrator to invite you.'),
                ]);
            }
